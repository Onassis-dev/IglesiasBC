    ...
    function ShareButtons() {
      var FB_LINK_FORMAT =
        ...
        NOT_SUPPORTED_MESSAGE =
          "This feature is not supported on this browser or operating system.";
      ...
      var share = function (id, urlDef, titleDef, descDef) {
        ...
        switch (id) {
          ...
          case TW_CLASS_NAME:
            popupCenter(
              stringFormat(TW_LINK_FORMAT, [url, mergeForTitle([title, desc])]),
              titleDef
            );
            break;
          ...
          case WA_CLASS_NAME:
            popupCenter(
              stringFormat(WA_LINK_FORMAT, [mergeForTitle([title, desc]), url]),
              titleDef
            );
            break;
      ...
      var popupCenter = function (url, title) {
        var _w = 600,
          _h = 400,
          dualScreenLeft =
            typeof w.screenLeft !== "undefined" ? w.screenLeft : screen.left,
          dualScreenTop =
            typeof w.screenTop !== "undefined" ? w.screenTop : screen.top,
