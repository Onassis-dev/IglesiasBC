...
//     pastors: z.string().max(70, 'El campo de pastores debe tener máximo 70 caracteres.').optional().nullable(),
//     servicesDates: z.string().max(100, 'El campo de servicios debe tener máximo 100 caracteres.').optional().nullable(),
//     mission: z
//         .string()
...
//         .optional()
//         .nullable(),
//     facebookLink: z.string().max(255, 'El enlace de Facebook no puede exceder los 255 caracteres.').optional().nullable(),
//     instagramLink: z.string().max(255, 'El enlace de Instagram no puede exceder los 255 caracteres.').optional().nullable(),
//     whatsappLink: z.string().max(255, 'El enlace de WhatsApp no puede exceder los 255 caracteres.').optional().nullable(),
//     mapsLink: z.string().max(255, 'El enlace a la ubicación en el mapa no puede exceder los 255 caracteres.').optional().nullable(),
//     youtubeLink: z.string().max(255, 'El enlace de YouTube no puede exceder los 255 caracteres.').optional().nullable(),
//     preachLink: z.string().max(255, 'El enlace de la prédica no puede exceder los 255 caracteres.').optional().nullable(),
//     donationLink: z.string().max(255, 'El enlace de la donación no puede exceder los 255 caracteres.').optional().nullable(),
//     animations: z.string().max(1).optional(),
//     ubication: z.string().max(100, 'La ubicación debe tener máximo 100 caracteres.').optional().nullable(),
//     description: z.string().max(250, 'La descripción no puede exceder los 250 caracteres.').optional().nullable(),
//     about: z.string().max(300, "El campo 'Sobre Nosotros' no puede exceder los 300 caracteres.").optional().nullable(),
