...
const PaginationLink = ({ className, isActive, size = "icon", ...props }: PaginationLinkProps) => (
    <p
        ...
        className={cn(
            ...
            "cursor-pointer select-none size-9 shadow-sm",
            className
        )}
        {...props}
    />
...
const PaginationPrevious = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => (
    <PaginationLink aria-label="Go to previous page" size="default" className={cn("aspect-square p-0", className)} {...props}>
...
const PaginationNext = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => (
    <PaginationLink aria-label="Go to next page" size="default" className={cn("aspect-square p-0", className)} {...props}>
