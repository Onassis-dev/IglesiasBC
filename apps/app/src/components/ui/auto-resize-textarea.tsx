    ...
    (
        ...
        return (
            <textarea
                ...
                ref={textAreaRef}
                className={cn(
                    'flex w-full rounded-md bg-background px-0 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
                    className
                )}
                onChange={(e) => {
