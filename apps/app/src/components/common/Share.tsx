            ...
            {navigator.share ? (
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                        ...
                        <DropdownMenuSeparator />
                        <DropdownMenuGroup>
                            <DropdownMenuItem className="flex items-center gap-2" onClick={() => openLink(FB_LINK)}>
                            ...
                            <DropdownMenuItem className="flex items-center gap-2" onClick={() => openLink(WA_LINK)}>
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-4">
                                    <path
                                        fill="#25D366"
